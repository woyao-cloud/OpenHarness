...
('admin', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('admin1', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin1@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('admin2', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('admin3', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin3@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('admin4', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('admin5', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin5@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('admin6', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin6@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('admin7', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin7@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('admin8', '$2a$10$enk/6WkSsHogyopFk/Gazu9EaGlJlvIMA.yT6HKSWIKPN1wd9atZm', '管理员', 'admin8@example.com', 'ADMIN', 1)
ON CONFLICT (username) DO NOTHING;
...
-- 插入默认普通用户账号 (密码: user123)
INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('user1', '$2a$10$7sXo9m1Z5n8u9v1z5y6OeO8j3k4l5m6n7o8p9q0r1s2t3u4v5w6x7y8z9', '普通用户1', 'user1@example.com', 'USER', 1)
ON CONFLICT (username) DO NOTHING;
INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('user2', '$2a$10$7sXo9m1Z5n8u9v1z5y6OeO8j3k4l5m6n7o8p9q0r1s2t3u4v5w6x7y8z9', '普通用户2', 'user2@example.com', 'USER', 1)
 ON CONFLICT (username) DO NOTHING;

INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('user3', '$2a$10$7sXo9m1Z5n8u9v1z5y6OeO8j3k4l5m6n7o8p9q0r1s2t3u4v5w6x7y8z9', '普通用户3', 'user3@example.com', 'USER', 1)
 ON CONFLICT (username) DO NOTHING;

 INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('user4', '$2a$10$7sXo9m1Z5n8u9v1z5y6OeO8j3k4l5m6n7o8p9q0r1s2t3u4v5w6x7y8z9', '普通用户4', 'user4@example.com', 'USER', 1)
 ON CONFLICT (username) DO NOTHING;
INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('user5', '$2a$10$7sXo9m1Z5n8u9v1z5y6OeO8j3k4l5m6n7o8p9q0r1s2t3u4v5w6x7y8z9', '普通用户5', 'user5@example.com', 'USER', 1)
 ON CONFLICT (username) DO NOTHING;
  INSERT INTO sys_user (username, password, nickname, email, role, status) VALUES 
('user6', '$2a$10$7sXo9m1Z5n8u9v1z5y6OeO8j3k4l5m6n7o8p9q0r1s2t3u4v5w6x7y8z9', '普通用户6', 'user6@example.com', 'USER', 1)
ON CONFLICT (username) DO NOTHING;    